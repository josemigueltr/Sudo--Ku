...
CREATE TABLE opinion (
	...
	CONSTRAINT opinion_FK FOREIGN KEY (username) REFERENCES ebarrotes.comprador(username),
	CONSTRAINT opinion_FK_1 FOREIGN KEY (id_producto) REFERENCES ebarrotes.producto(id_producto)
)
ENGINE=InnoDB
DEFAULT CHARSET=utf8mb4
COLLATE=utf8mb4_0900_ai_ci;
